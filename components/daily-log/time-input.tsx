    ...
    <div className="space-y-2">
      ...
      <div className={cn(
        ...
        <input
          ...
          autoComplete="off"
          aria-label={label ? undefined : 'Time input'}
        ...
        {isFocused && !disabled && (
          <div className="flex gap-1 border-l pl-2">
            <button
              ...
              className="text-xs font-medium px-1.5 py-0.5 rounded hover:bg-muted focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none"
            >
              +1m
            </button>
            <button
        ...
        {displayValue && !disabled && (
          <button
            ...
            className="text-muted-foreground hover:text-foreground rounded p-0.5 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none"
            title="Clear"
