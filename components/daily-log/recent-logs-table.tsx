  ...
  return (
    <div className="space-y-3">
              ...
              <td className="px-3 py-2">
                <div className="flex items-center justify-end gap-2">
                  ...
                  {canDelete ? (
                    <button
                      type="button"
                      onClick={() => setLogToDelete({ id: log.entry_id, date: log.entry_date })}
                      ...
                      title="Delete"
                      aria-label="Delete"
                      disabled={isPending && logToDelete?.id === log.entry_id}
                    >
      ...
      {logToDelete && (
        <ConfirmDialog
          title="Delete Log"
          description={`Are you sure you want to delete the log for ${logToDelete.date}? This action cannot be undone.`}
          confirmText="Delete"
          isLoading={isPending}
