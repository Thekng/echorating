    ...
    <div className="space-y-3">
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  {canDelete ? (
                    <button
                      ...
                      title="Delete"
                      aria-label={`Delete log for ${formatDateShort(log.report_date)}`}
                    >
      ...
      {logToDelete && (
        <ConfirmDialog
          ...
          description={`Are you sure you want to delete the daily log for ${formatDateShort(logToDelete.report_date)} permanently?`}
          onConfirm={() => {
