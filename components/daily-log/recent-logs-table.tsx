...
export function RecentLogsTable({
  ...
  const [logToDelete, setLogToDelete] = React.useState<DailyLogRecentEntry | null>(null)
    ...
    <div className="space-y-3">
      ...
      {logToDelete && (
        <ConfirmDialog
          ...
          description={`Are you sure you want to delete the log for ${logToDelete.user_name} on ${formatDateShort(logToDelete.report_date)}? This action cannot be undone.`}
