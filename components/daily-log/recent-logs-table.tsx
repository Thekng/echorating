...
export function RecentLogsTable({
  ...
  const [itemToDelete, setItemToDelete] = useState<DailyLogRecentEntry | null>(null)
    ...
    <div className="space-y-3">
      ...
      {itemToDelete && (
        <ConfirmDialog
          ...
          description={`This will remove the log entry for ${formatDateShort(itemToDelete.entry_date)}.`}
