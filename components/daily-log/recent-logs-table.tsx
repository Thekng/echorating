...
export function RecentLogsTable({
  ...
  const [selectedItem, setSelectedItem] = useState<DailyLogRecentEntry | null>(null)
    ...
    <div className="space-y-3">
      ...
      {selectedItem && (
        <ConfirmDialog
          ...
          description={`Are you sure you want to delete the log for ${formatDateShort(selectedItem.report_date)}? This action cannot be undone.`}
          confirmText="Delete"
          isLoading={isPending}
          loadingText="Deleting..."
          onConfirm={() => {
            const formData = new FormData()
            formData.append('entryId', selectedItem.id)
