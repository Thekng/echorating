    ...
    <div className="space-y-3">
      ...
      {logToDelete && (
        <ConfirmDialog
          ...
          description={`Are you sure you want to delete the log for ${formatDateShort(logToDelete.entry_date)}? This action cannot be undone.`}
          confirmText="Delete"
          variant="destructive"
          ...
          onConfirm={() => {
            startDeleteTransition(async () => {
              try {
                ...
                formData.set('entryId', logToDelete.entry_id)
