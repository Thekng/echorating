  ...
  return (
    <div className="space-y-3">
      ...
      <ConfirmDialog
        ...
        description="This will permanently delete this log entry and all its associated metric values. This action cannot be undone."
        confirmText="Delete"
        isLoading={isPending}
        ...
        onConfirmAction={() => {
          ...
          startTransition(() => {
            ...
            void deleteDailyLogAction(formData).then(() => {
              setLogToDelete(null)
            })
          })
        }}
