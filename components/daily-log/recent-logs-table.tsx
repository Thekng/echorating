...
export function RecentLogsTable({
  ...
  function handleDelete() {
    ...
    startTransition(() => {
      ...
      formData.append('entryId', deleteId)
      const promise = deleteDailyLogAction(null, formData)
      promise.then(() => {
        setDeleteId(null)
      })
    })
    ...
    <div className="space-y-3">
      ...
      {deleteId && (
        <ConfirmDialog
          ...
          description="Are you sure you want to delete this log entry permanently? This action cannot be undone."
          confirmText="Delete"
          cancelText="Cancel"
          isLoading={isPending}
