  ...
  return (
    <div className="relative">
      ...
      {isOpen && filtered.length > 0 && (
        <div id="metrics-search-listbox" role="listbox" aria-label="Search results" className="absolute top-full left-0 right-0 mt-2 rounded-md border bg-popover shadow-md z-50 max-h-64 overflow-y-auto">
          {filtered.map((metric) => (
            <button
