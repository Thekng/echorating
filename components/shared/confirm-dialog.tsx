  ...
  return (
    <Dialog.Root open={open ?? true} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content role="alertdialog" className="fixed left-[50%] top-[50%] z-50 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-xl border bg-card p-6 shadow-lg animate-in fade-in-0 zoom-in-95 focus:outline-none">
          ...
          <div className="mt-5 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
            <Button variant="outline" onClick={() => { onCancel?.(); onOpenChange?.(false); }} disabled={isLoading}>Cancel</Button>
